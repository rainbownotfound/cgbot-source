...
const randomFooter = () => {
    return exports.randomSelection([
        'This message was a Labyrinth to make',
        'I Got No Time for your nonsense',
        'Your Reality makes no sense',
        'In here, I will draw The Final Straw',
        'The Spotlight is mine to take',
        'All of your Opinions count as much as mine.',
        'You can say Absolutely Anything, but I love myself',
        'This bot would not exist Without You, Charlie',
        'I can do this Infinite times',
        'You Will Believe that Waluigi is our God now',
        'Take my hand, man',
        'Let\'s go play some Connect Four after this.',
        'Love and Sacrifice was put into this bot.',
        'This is just CGBot and nothing more',
        'Something\'s Crawling in my soup',
        'I guess there\'s No More Cake to eat'
    ]);
};
